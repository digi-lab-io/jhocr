...
public class HocrPageProcessor {
    ...
    /**
     * @param hocrPage         this object will be processed in this class.
     * @param imageInputStream of the image.
     * @param useImageDpi      determines if the dpi of the image should be used.
     */
     ...
     *
     * @param cb          here the character spacing will be processed.
     * @param hocrWord    will be used to process the {@link PdfContentByte}.
     * @param wordWidthPt will be used to process the {@link PdfContentByte}.
     */
     ...
     *
     * @param document  will be processed.
