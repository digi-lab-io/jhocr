...
package com.github.ossdevs.jhocr.element;

import com.github.ossdevs.jhocr.attribute.BBox;
import com.github.ossdevs.jhocr.attribute.ParagraphDirection;
...
public class HocrParagraph extends HocrElement {
    ...
    /**
     * Constructs the {@link HocrParagraph} with a unique id and a coordinates {@link BBox}.
     *
     * @param id    sets the id of element.
     * @param bbox  sets the coordinates of element.
     * @param image sets the {@link ParagraphDirection} of element.
     */
    ...
    /**
     * Adds a new {@link HocrLine#line} to the current {@link#lines}.
     *
     * @param line will be added to {@link#lines}.
     */
